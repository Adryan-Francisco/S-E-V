...
namespace SEV.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,Nome,Descricao,Preco,QuantidadeEstoque,CategoriaId,FornecedorId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,Nome,Descricao,Preco,QuantidadeEstoque,CategoriaId,FornecedorId")] Produto produto)
        {
